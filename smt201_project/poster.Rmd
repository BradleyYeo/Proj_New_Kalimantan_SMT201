...
## Problem:
> Indonesia needs to relocate the new capital from Jakarta to city in East Kalimantan, Borneo.

> It is very difficult to analyse the entire province of East Kalimantan using either Google Maps or hand-drawn maps. This is because of the huge land area and many differences in topological characteristics of the land.
...
## GIS Analysis Techniques used (Approach):
1. Raster Distance
2. Binary Analysis
3. Proximity Analysis
4. Accessibility to Seaports and Airports
5. GIS-Based Multiple-Criteria Decision Analysis
6. Choropleth Maps
